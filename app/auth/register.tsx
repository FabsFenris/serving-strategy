...
export default function RegisterPage() {
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#F9F9F8', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', padding: '24px', fontFamily: 'sans-serif', color: '#111827' }}>
      <div style={{ width: '100%', maxWidth: '420px', backgroundColor: '#FFFFFF', padding: '32px 24px', borderRadius: '16px', border: '1px solid #E5E7EB', boxShadow: '0 4px 12px rgba(0,0,0,0.03)' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '24px' }}>
          ...
          <h1 style={{ fontSize: '22px', fontWeight: '700', color: '#064E3B', margin: '0 0 6px 0' }}>Create an Account</h1>
          <p style={{ fontSize: '13px', color: '#6B7280', margin: 0 }}>Join Serving Strategy marketplace</p>
        </div>
        ...
        <form style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <p style={{ fontSize: '11px', color: '#6B7280', margin: '4px 0 0 0', lineHeight: '1.4' }}>
            By registering, you agree that promotional store credit is non-withdrawable and reserved strictly for eligible marketplace purchases.
          </p>
